...
! define topology of the control element
  ...
  if(myrank == 0) then
    write(IMAIN,*)
    write(IMAIN,*) '*****************************************************************'
    write(IMAIN,*) 'reading receiver information from the DATA/STATIONS_FILTERED file'
    write(IMAIN,*) '*****************************************************************'
  endif

! get number of stations from receiver file
  open(unit=1,file='DATA/STATIONS_FILTERED',status='old')
  read(1,*) nrec_dummy
