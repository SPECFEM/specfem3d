...
#
#  EXAMPLE:
#     view_model_new.pl 2 m0 1.0 Beta
#     view_model_new.pl 1 m0 1.0 Bulk
#
#---------------------------------

use File::Basename;

if (@ARGV < 4) {die("Usage: view_model_new.pl xxx\n")}
($iker,$smodel,$cmax,$fname) = @ARGV;

$dmtag = $fname;

$tcl_tag = "view_model_new";
...
# directories
$dir_mesh = "/net/sierra/raid1/carltape/socal/socal_3D/RUNS/MODELS/${smodel}";
$dir_ker_lab = "\\/net\\/sierra\\/raid1\\/carltape\\/socal\\/socal_3D\\/RUNS\\/MODELS\\/${smodel}";
