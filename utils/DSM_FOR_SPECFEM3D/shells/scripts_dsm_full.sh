...
echo $NPROC
echo $OPTION
echo $BIN/xTraPSV_write_ceof_mpi_SH
echo $BIN/xTraPSV_write_ceof_mpi_PSV
$MPIRUN $OPTION $BIN/xTraPSV_write_ceof_mpi_SH
...
{
$MPIRUN $OPTION $BIN/xTraPSV_MPI_read_ceof_vert_SH $1
...
{
$MPIRUN $OPTION $BIN/xTraPSV_MPI_read_zmin_SH $1
...
function fft_vert ()
{
$MPIRUN $OPTION $BIN/fft_face_vert_full $1
}
...
function fft_zmin ()
{
$MPIRUN $OPTION $BIN/TraFFT_MPI_face_zmin_full $1
}
