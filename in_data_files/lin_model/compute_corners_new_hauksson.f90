...
!! DK DK compute corners of new interpolated Hauksson model
  ...
  double precision, parameter :: ORIG_LONG_HAUKSSON = -121.3d0,END_LONG_HAUKSSON = -112.9d0
  double precision, parameter :: ORIG_LAT_HAUKSSON = 30.7d0,END_LAT_HAUKSSON = 37.7d0
