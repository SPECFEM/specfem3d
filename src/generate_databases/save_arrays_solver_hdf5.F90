...
print*, myrank, "DEBUG 0008"
  ...
  dset_name = "xix_regular" ! 1 r (/myrank/)
  call h5_write_dataset_1d_r_collect_hyperslab(h5,dset_name,(/xix_regular/),(/myrank/),if_col)
  dset_name = "jacobian_regular" ! 1 r (/myrank/)
  call h5_write_dataset_1d_r_collect_hyperslab(h5,dset_name,(/jacobian_regular/),(/myrank/),if_col)
  dset_name = "xixstore" ! 4 r  (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,xixstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "xiystore" ! 4 r  (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,xiystore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "xizstore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,xizstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "etaxstore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,etaxstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "etaystore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,etaystore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "etazstore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,etazstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "gammaxstore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,gammaxstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "gammaystore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,gammaystore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "gammazstore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,gammazstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "jacobianstore" ! 4 r (/0,0,0,offset_nspec_irregular=offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,jacobianstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
  dset_name = "kappastore" ! 4 r (/0,0,0,offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,kappastore,(/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
  dset_name = "mustore" ! 4 r (/0,0,0,offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5,dset_name,mustore,(/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
  dset_name = "ispec_is_acoustic" ! 1 l (/0,0,0,offset_nspec/)
  call h5_write_dataset_1d_l_collect_hyperslab(h5, dset_name, ispec_is_acoustic, (/sum(offset_nspec(0:myrank-1))/),if_col)
  dset_name = "ispec_is_elastic" ! 1 l (/0,0,0,offset_nspec/)
  call h5_write_dataset_1d_l_collect_hyperslab(h5, dset_name, ispec_is_elastic, (/sum(offset_nspec(0:myrank-1))/),if_col)
  dset_name = "ispec_is_poroelastic" ! 1 l (/0,0,0,offset_nspec/)
  call h5_write_dataset_1d_l_collect_hyperslab(h5, dset_name, ispec_is_poroelastic, (/sum(offset_nspec(0:myrank-1))/),if_col)

  ! acoustic
  if (ACOUSTIC_SIMULATION) then
    dset_name = "rmass_acoustic" ! 1 r (/offset_nglob/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmass_acoustic,(/sum(offset_nglob(0:myrank-1))/),if_col)
  endif

  ! this array is needed for acoustic simulations but also for elastic simulations with CPML,
  ! thus we allocate it and read it in all cases (whether the simulation is acoustic, elastic, or acoustic/elastic)
  dset_name = "rhostore" ! 4 r (/0,0,0,offset_nspec/)
  call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, rhostore, (/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)

  ! elastic
  if (ELASTIC_SIMULATION) then
    dset_name = "rmass" ! 1 r (/offset_nglob/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmass, (/sum(offset_nglob(0:myrank-1))/), if_col)
    if (APPROXIMATE_OCEAN_LOAD) then
      dset_name = "rmass_ocean_load" ! 1 r (/offset_nglob_ocean/)
      call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmass_ocean_load, (/sum(offset_nglob_ocean(0:myrank-1))/),if_col)
    endif
    !pll Stacey
    dset_name = "rho_vp" ! 4 r (/0,0,0,offset_nspec/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, rho_vp, (/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
    dset_name = "rho_vs" ! 4 r (/0,0,0,offset_nspec/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, rho_vs, (/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
  endif

  ! poroelastic
  if (POROELASTIC_SIMULATION) then
    dset_name = "rmass_solid_poroelastic" ! 1 r (/offset_nglob/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmass_solid_poroelastic, (/sum(offset_nglob(0:myrank-1))/),if_col)
    dset_name = "rmass_fluid_poroelastic" ! 1 r (/offset_nglob/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmass_fluid_poroelastic, (/sum(offset_nglob(0:myrank-1))/),if_col)
    dset_name = "rhoarraystore" ! 5 r (/0,0,0,0,offset_nspecporo/)
    call h5_write_dataset_5d_r_collect_hyperslab(h5, dset_name, rhoarraystore, (/0,0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "kappaarraystore" ! 5 r (/0,0,0,0,offset_nspecporo/)
    call h5_write_dataset_5d_r_collect_hyperslab(h5, dset_name, kappaarraystore,&
              (/0,0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "etastore" ! 4 r (/0,0,0,offset_nspecporo/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, etastore, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "tortstore" ! 4 r (/0,0,0,offset_nspecporo/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, tortstore, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "permstore" ! 5 r (/0,0,0,0,offset_nspecporo/)
    call h5_write_dataset_5d_r_collect_hyperslab(h5, dset_name, permstore, (/0,0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "phistore" ! 4 r (/0,0,0,offset_nspecporo/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, phistore, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "rho_vpI" ! 4 r (/0,0,0,offset_nspecporo/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, rho_vpI, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "rho_vpII" ! 4 r (/0,0,0,offset_nspecporo/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, rho_vpII, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    dset_name = "rho_vsI" ! 4 r (/0,0,0,offset_nspecporo/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, rho_vsI, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
  endif

  ! C-PML absorbing boundary conditions
  if (PML_CONDITIONS) then
    dset_name = "nspec_cpml" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec_cpml/), (/myrank/),if_col)
    dset_name = "CPML_width_x" ! 1 r (/myrank/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, (/CPML_width_x/), (/myrank/),if_col)
    dset_name = "CPML_width_y" ! 1 r (/myrank/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, (/CPML_width_y/), (/myrank/),if_col)
    dset_name = "CPML_width_z" ! 1 r (/myrank/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, (/CPML_width_z/), (/myrank/),if_col)
    dset_name = "min_distance_between_CPML_parameter" ! 1 r (/myrank/)
    call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, (/min_distance_between_CPML_parameter/), (/myrank/),if_col)

    if (sum(offset_nspeccpml) > 0) then
      dset_name = "CPML_regions" ! 1 i (/offset_nspeccpml/)
      call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, CPML_regions, (/sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "CPML_to_spec" ! 1 i (/offset_nspeccpml/)
      call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, CPML_to_spec, (/sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "is_CPML" ! 1 l (/offset_nspecab/)
      call h5_write_dataset_1d_l_collect_hyperslab(h5, dset_name, is_CPML, (/sum(offset_nspec_ab(0:myrank-1))/),if_col)
      dset_name = "d_store_x" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, d_store_x, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "d_store_y" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, d_store_y, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "d_store_z" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, d_store_z, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "k_store_x" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, k_store_x, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "k_store_y" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, k_store_y, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "k_store_z" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, k_store_z, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "alpha_store_x" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, alpha_store_x, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "alpha_store_y" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, alpha_store_y, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      dset_name = "alpha_store_z" ! 4 r (/0,0,0,offset_nspeccpml/)
      call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, alpha_store_z, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      ...
      if ((SIMULATION_TYPE == 1 .and. SAVE_FORWARD) .or. SIMULATION_TYPE == 3) then
        dset_name = "nglob_interface_PML_acoustic" ! 1 i (/myrank/)
        call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nglob_interface_PML_acoustic/), (/myrank/),if_col)
        dset_name = "nglob_interface_PML_elastic" ! 1 i (/myrank/)
        call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nglob_interface_PML_elastic/), (/myrank/),if_col)
        if (sum(offset_nglob_interface_PML_acoustic) > 0) then
          dset_name = "points_interface_PML_acoustic" ! 1 i (/offset_nglob_interface_PML_acoustic/)
  ...
  ! absorbing boundary surface
  dset_name = "num_abs_boundary_faces" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/num_abs_boundary_faces/), (/myrank/),if_col)
  ...
  if (sum(offset_num_abs_boundary_faces) > 0) then
    ...
    if (STACEY_ABSORBING_CONDITIONS .and. (.not. PML_CONDITIONS)) then
      ...
      if (ELASTIC_SIMULATION) then
        dset_name = "rmassx" ! 1 r (/offset_nglob_xy/)
        call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmassx, (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
        dset_name = "rmassy" ! 1 r (/offset_nglob_xy/)
        call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmassy, (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
        dset_name = "rmassz" ! 1 r (/offset_nglob_xy/)
        call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmassz, (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
     endif
      if (ACOUSTIC_SIMULATION) then
        dset_name = "rmassz_acoustic" ! 1 r (/offset_nglob_xy/)
        call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, rmassz_acoustic, (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
     endif
    endif
  else
    dset_name = "abs_boundary_ispec" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/0/), (/myrank/),if_col)
    dset_name = "abs_boundary_ijk" ! 3 i (/0,0,myrank/)
    call h5_write_dataset_3d_i_collect_hyperslab(h5, dset_name, i3d_dummy, (/0,0,myrank/),if_col)
    dset_name = "abs_boundary_jacobian2Dw" ! 2 r (/0,myrank/)
    call h5_write_dataset_2d_r_collect_hyperslab(h5, dset_name, r2d_dummy, (/0,myrank/),if_col)
    dset_name = "abs_boundary_normal" ! 3 r (/0,0,myrank/)
    call h5_write_dataset_3d_r_collect_hyperslab(h5, dset_name, r3d_dummy, (/0,0,myrank/),if_col)

    if (STACEY_ABSORBING_CONDITIONS .and. (.not. PML_CONDITIONS)) then
      ! store mass matrix contributions
      if (ELASTIC_SIMULATION) then
        dset_name = "rmassx" ! 1 r (/myrank/)
        call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, (/0.0/), (/myrank/),if_col)
        dset_name = "rmassy" ! 1 r (/myrank/)
        call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, (/0.0/), (/myrank/),if_col)
        dset_name = "rmassz" ! 1 r (/myrank/)
        call h5_write_dataset_1d_r_collect_hyperslab(h5, dset_name, (/0.0/), (/myrank/),if_col)
  ...
  dset_name = "nspec2D_xmin" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec2D_xmin/), (/myrank/),if_col)
  dset_name = "nspec2D_xmax" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec2D_xmax/), (/myrank/),if_col)
  dset_name = "nspec2D_ymin" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec2D_ymin/), (/myrank/),if_col)
  dset_name = "nspec2D_ymax" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec2D_ymax/), (/myrank/),if_col)
  dset_name = "NSPEC2D_BOTTOM" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec2D_bottom/), (/myrank/),if_col)
  dset_name = "NSPEC2D_TOP" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec2D_top/), (/myrank/),if_col)
  dset_name = "ibelm_xmin" ! 1 i (/offset_nspec2D_xmin/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, ibelm_xmin, (/sum(offset_nspec2D_xmin(0:myrank-1))/),if_col)
  dset_name = "ibelm_xmax" ! 1 i (/offset_nspec2D_xmax/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, ibelm_xmax, (/sum(offset_nspec2D_xmax(0:myrank-1))/),if_col)
  dset_name = "ibelm_ymin" ! 1 i (/offset_nspec2D_ymin/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, ibelm_ymin, (/sum(offset_nspec2D_ymin(0:myrank-1))/),if_col)
  dset_name = "ibelm_ymax" ! 1 i (/offset_nspec2D_ymax/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, ibelm_ymax, (/sum(offset_nspec2D_ymax(0:myrank-1))/),if_col)
  dset_name = "ibelm_bottom" ! 1 i (/offset_nspec2D_bottom_ext/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, ibelm_bottom, (/sum(offset_nspec2D_bottom_ext(0:myrank-1))/),if_col)
  dset_name = "ibelm_top" ! 1 i (/offset_nspec2D_top_ext/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, ibelm_top, (/sum(offset_nspec2D_top_ext(0:myrank-1))/),if_col)

  ! free surface
  dset_name = "num_free_surface_faces" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/num_free_surface_faces/), (/myrank/),if_col)
  if (sum(offset_num_free_surface_faces) > 0) then
    dset_name = "free_surface_ispec" ! 1 i (/offset_num_free_surface_faces/)
  ...
  dset_name = "num_interfaces_ext_mesh" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/num_interfaces_ext_mesh/), (/myrank/),if_col)
  if (sum(offset_num_interfaces_ext_mesh) > 0) then
    dset_name = "max_nibool_interfaces_ext_mesh" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/max_nibool_interfaces_ext_mesh/), (/myrank/),if_col)
    dset_name = "my_neighbors_ext_mesh" ! 1 i (/offset_num_interfaces_ext_mesh/)
    ...
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/0/), (/myrank/),if_col)
    dset_name = "ibool_interfaces_ext_mesh_dummy" ! 2 i (/0,myrank/)
    call h5_write_dataset_2d_i_collect_hyperslab(h5, dset_name, i2d_dummy, (/myrank/),if_col)
  endif

  ! anisotropy
  if (ELASTIC_SIMULATION .and. ANISOTROPY) then
    dset_name = "c11store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c11store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c12store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c12store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c13store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c13store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c14store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c14store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c15store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c15store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c16store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c16store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c22store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c22store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c23store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c23store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c24store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c24store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c25store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c25store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c26store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c26store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c33store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c33store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c34store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c34store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c35store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c35store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c36store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c36store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c44store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c44store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c45store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c45store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c46store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c46store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c55store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c55store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c56store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c56store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    dset_name = "c66store" ! 4 r (/0,0,0,offset_nspec_aniso/)
    call h5_write_dataset_4d_r_collect_hyperslab(h5, dset_name, c66store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
  endif

  ! inner/outer elements
  dset_name = "ispec_is_inner" ! 1 l (/offset_nspec/)
  call h5_write_dataset_1d_l_collect_hyperslab(h5, dset_name, ispec_is_inner,(/sum(offset_nspec(0:myrank-1))/),if_col)

  if (ACOUSTIC_SIMULATION) then
     dset_name = "nspec_inner_acoustic" ! 1 i (/myrank/)
     call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec_inner_acoustic/),(/myrank/),if_col)
     dset_name = "nspec_outer_acoustic" ! 1 i (/myrank/)
     call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec_outer_acoustic/),(/myrank/),if_col)
     dset_name = "num_phase_ispec_acoustic" ! 1 i (/myrank/)
     call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/num_phase_ispec_acoustic/),(/myrank/),if_col)
    if (sum(offset_num_phase_ispec_acoustic) > 0) then
      dset_name = "phase_ispec_inner_acoustic" ! 2 i (/offset_num_phase_ispec_acoustic, 0/)
      ...
      dset_name = "phase_ispec_inner_acoustic" ! 2 i (/myrank,0/)
      call h5_write_dataset_2d_i_collect_hyperslab(h5, dset_name, i2d_dummy,(/myrank,0/),if_col)
    endif
  endif

  if (ELASTIC_SIMULATION) then
    dset_name = "nspec_inner_elastic" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec_inner_elastic/),(/myrank/),if_col)
    dset_name = "nspec_outer_elastic" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec_outer_elastic/),(/myrank/),if_col)
    dset_name = "num_phase_ispec_elastic" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/num_phase_ispec_elastic/),(/myrank/),if_col)
    if (sum(offset_num_phase_ispec_elastic) > 0) then
      dset_name = "phase_ispec_inner_elastic" ! 2 i (/offset_num_phase_ispec_elastic,0/)
  ...
  if (POROELASTIC_SIMULATION) then
    dset_name = "nspec_inner_poroelastic" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec_inner_poroelastic/),(/myrank/),if_col)
    dset_name = "nspec_outer_poroelastic" ! 1 i (/myrank/)
    call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nspec_outer_poroelastic/),(/myrank/),if_col)
    dset_name = "num_phase_ispec_poroelastic" ! 1 i (/myrank/)
  ...
  ! surface points
  dset_name = "nfaces_surface" ! 1 i (/myrank/)
  call h5_write_dataset_1d_i_collect_hyperslab(h5, dset_name, (/nfaces_surface/), (/myrank/), if_col)
  dset_name = "ispec_is_surface_external_mesh" ! 1 l (/offset_nspec_ab/)
