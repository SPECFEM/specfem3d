...
!    end subroutine h5_write_dataset_p_1d_i
    ...
    subroutine h5_gather_dsetsize(this, dimin, data_rank, all_dim)
        ...
        integer, dimension(:,:), intent(inout)      :: all_dim
