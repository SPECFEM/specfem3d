...
! initializes arrays
  ...
  use specfem_par,only: NPROC,NTSTEP_BETWEEN_OUTPUT_SEISMOS,NSTEP,DT,NGNOD,NGNOD2D, &
    UTM_PROJECTION_ZONE,SUPPRESS_UTM_PROJECTION,TOMOGRAPHY_PATH, &
    ATTENUATION,USE_OLSEN_ATTENUATION,LOCAL_PATH,NSOURCES, &
    APPROXIMATE_OCEAN_LOAD,TOPOGRAPHY,ANISOTROPY,STACEY_ABSORBING_CONDITIONS, &
    ...
    ADIOS_FOR_KERNELS, &
    NSPEC_AB,NGLOB_AB,myrank

  use specfem_par_movie,only: MOVIE_TYPE, &
