...
! reads in the value of NSPEC_AB and NGLOB_AB
  ...
  if (I_should_read_the_database) then
    ...
    ! read datasets
    dsetname = "nspec"
    !call h5_read_dataset_p_scalar_i(dsetname, NSPEC_AB)
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, NSPEC_AB, (/myrank/),if_col)
    dsetname = "nglob"
    !call h5_read_dataset_p_scalar_i(dsetname, NGLOB_AB)
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, NGLOB_AB, (/myrank/),if_col)
    dsetname = "nspec_irregular"
    !call h5_read_dataset_p_scalar_i(dsetname, NSPEC_IRREGULAR)
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, NSPEC_IRREGULAR, (/myrank/),if_col)
...
! reads in full database
  ...
  if (I_should_read_the_database) then
    ...
    ! gets offsets
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nglob",offset_nglob, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec",offset_nspec, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec_irregular",offset_nspec_irregular, (/0/), if_col)

    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec2D_xmin",offset_nspec2D_xmin, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec2D_xmax",offset_nspec2D_xmax, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec2D_ymin",offset_nspec2D_ymin, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec2D_ymax",offset_nspec2D_ymax, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec2D_bottom_ext",offset_nspec2D_bottom_ext, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec2D_top_ext",offset_nspec2D_top_ext, (/0/), if_col)

    call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec_ab",offset_nspec_ab, (/0/), if_col)
    call h5_read_dataset_1d_i_collect_hyperslab("offset_nglob_ab",offset_nglob_ab, (/0/), if_col)
    ...
    dsetname = "ibool"
    call h5_read_dataset_4d_i_collect_hyperslab(dsetname, ibool, (/0,0,0,sum(offset_nglob(0:myrank-1))/), if_col)
    dsetname = "xstore_unique"
    call h5_read_dataset_1d_r_collect_hyperslab(dsetname,xstore,(/sum(offset_nglob(0:myrank-1))/),if_col)
    dsetname = "ystore_unique"
    call h5_read_dataset_1d_r_collect_hyperslab(dsetname,ystore,(/sum(offset_nglob(0:myrank-1))/),if_col)
    dsetname = "zstore_unique"
    call h5_read_dataset_1d_r_collect_hyperslab(dsetname,zstore,(/sum(offset_nglob(0:myrank-1))/),if_col)

    dsetname = "irregular_element_number"
    call h5_read_dataset_1d_i_collect_hyperslab(dsetname,irregular_element_number,(/sum(offset_nspec(0:myrank-1))/),if_col)
    dsetname = "xix_regular"
    call h5_read_dataset_scalar_r_collect_hyperslab(dsetname,xix_regular,(/myrank/),if_col)
    dsetname = "jacobian_regular"
    call h5_read_dataset_scalar_r_collect_hyperslab(dsetname,jacobian_regular,(/myrank/),if_col)

    dsetname = "xixstore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,xixstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "xiystore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,xiystore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "xizstore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,xizstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "etaxstore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,etaxstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "etaystore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,etaystore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "etazstore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,etazstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "gammaxstore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,gammaxstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "gammaystore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,gammaystore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "gammazstore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,gammazstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)
    dsetname = "jacobianstore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,jacobianstore,(/0,0,0,sum(offset_nspec_irregular(0:myrank-1))/),if_col)

    dsetname = "ispec_is_acoustic"
    call h5_read_dataset_1d_l_collect_hyperslab(dsetname, ispec_is_acoustic, (/sum(offset_nspec(0:myrank-1))/),if_col)
    dsetname = "ispec_is_elastic"
    call h5_read_dataset_1d_l_collect_hyperslab(dsetname, ispec_is_elastic, (/sum(offset_nspec(0:myrank-1))/),if_col)
    dsetname = "ispec_is_poroelastic"
    call h5_read_dataset_1d_l_collect_hyperslab(dsetname, ispec_is_poroelastic, (/sum(offset_nspec(0:myrank-1))/),if_col)

    dsetname = "kappastore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,kappastore,(/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
    dsetname = "mustore"
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname,mustore,(/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
  endif
  ...
  if (ACOUSTIC_SIMULATION) then
    ...
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmass_acoustic,(/sum(offset_nglob(0:myrank-1))/),if_col)
    endif
...
! read it in all cases (whether the simulation is acoustic, elastic, or acoustic/elastic)
  if (I_should_read_the_database) then
    dsetname = "rhostore"
    !call h5_read_dataset_p_4d_r(dsetname, rhostore)
    call h5_read_dataset_4d_r_collect_hyperslab(dsetname, rhostore, (/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
  endif
  ...
  if (ELASTIC_SIMULATION) then
    ...
    if (I_should_read_the_database) then
      dsetname = "rmass"
      call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmass, (/sum(offset_nglob(0:myrank-1))/), if_col)
    endif
    ...
    if (APPROXIMATE_OCEAN_LOAD) then
      ...
      if (I_should_read_the_database) then
        call h5_read_dataset_1d_i_collect_hyperslab("offset_nglob_ocean",offset_nglob_ocean, (/0/), if_col)
        dsetname = "rmass_ocean_load"
        call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmass_ocean_load, (/sum(offset_nglob_ocean(0:myrank-1))/),if_col)
      endif
    ...
    if (I_should_read_the_database) then
      dsetname = "rho_vp"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, rho_vp, (/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
    endif
    if (size(rho_vp) > 0) call bcast_all_cr_for_database(rho_vp(1,1,1,1), size(rho_vp))
    if (I_should_read_the_database) then
      dsetname = "rho_vs"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, rho_vs, (/0,0,0,sum(offset_nspec(0:myrank-1))/),if_col)
    endif
  ...
  if (POROELASTIC_SIMULATION) then
    ...
    if (I_should_read_the_database) then
      call h5_read_dataset_1d_i_collect_hyperslab("offset_nspecporo",offset_nspecporo, (/0/), if_col)
      dsetname = "rmass_solid_poroelastic"
      call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmass_solid_poroelastic, (/sum(offset_nglob(0:myrank-1))/),if_col)
      dsetname = "rmass_fluid_poroelastic"
      call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmass_fluid_poroelastic, (/sum(offset_nglob(0:myrank-1))/),if_col)
      ...
      dsetname = "tortstore"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, tortstore, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
      dsetname = "permstore"
      call h5_read_dataset_5d_r_collect_hyperslab(dsetname, permstore, (/0,0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
      dsetname = "phistore"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, phistore, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
      dsetname = "rho_vpI"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, rho_vpI, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
      dsetname = "rho_vpII"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, rho_vpII, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
      dsetname = "rho_vsI"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, rho_vsI, (/0,0,0,sum(offset_nspecporo(0:myrank-1))/),if_col)
    endif
...
! and then below if NSPEC_CPML > 0 we will read the real flags for this mesh from the disk
  ...
  if (PML_CONDITIONS) then
    if (I_should_read_the_database) then
      call h5_read_dataset_1d_i_collect_hyperslab("offset_nspeccpml",offset_nspeccpml, (/0/), if_col)
      dsetname = "nspec_cpml"
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, NSPEC_CPML, (/myrank/),if_col)
      dsetname = "CPML_width_x"
      call h5_read_dataset_scalar_r_collect_hyperslab(dsetname, CPML_width_x, (/myrank/),if_col)
      dsetname = "CPML_width_y"
      call h5_read_dataset_scalar_r_collect_hyperslab(dsetname, CPML_width_y, (/myrank/),if_col)
      dsetname = "CPML_width_z"
      call h5_read_dataset_scalar_r_collect_hyperslab(dsetname, CPML_width_z, (/myrank/),if_col)
      dsetname = "min_distance_between_CPML_parameter"
      call h5_read_dataset_scalar_r_collect_hyperslab(dsetname, min_distance_between_CPML_parameter, (/myrank/),if_col)
    endif
    ...
    if (sum(offset_nspeccpml) > 0) then
      ...
      if (I_should_read_the_database) then
        ...
        call h5_read_dataset_1d_i_collect_hyperslab(dsetname, CPML_regions, (/sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "CPML_to_spec"
        call h5_read_dataset_1d_i_collect_hyperslab(dsetname, CPML_to_spec, (/sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "is_CPML"
        call h5_read_dataset_1d_l_collect_hyperslab(dsetname, is_CPML, (/sum(offset_nspec_ab(0:myrank-1))/),if_col)
        dsetname = "d_store_x"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, d_store_x, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "d_store_y"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, d_store_y, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "d_store_z"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, d_store_z, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "k_store_x"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, k_store_x, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "k_store_y"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, k_store_y, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "k_store_z"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, k_store_z, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "alpha_store_x"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, alpha_store_x, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "alpha_store_y"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, alpha_store_y, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
        dsetname = "alpha_store_z"
        call h5_read_dataset_4d_r_collect_hyperslab(dsetname, alpha_store_z, (/0,0,0,sum(offset_nspeccpml(0:myrank-1))/),if_col)
      endif
      ...
      if ((SIMULATION_TYPE == 1 .and. SAVE_FORWARD) .or. SIMULATION_TYPE == 3) then
        ! acoustic
        if (I_should_read_the_database) then
          call h5_read_dataset_1d_i_collect_hyperslab( &
                           "offset_nglob_interface_PML_acoustic",offset_nglob_interface_PML_acoustic, (/0/), if_col)
          dsetname = "nglob_interface_PML_acoustic"
          call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nglob_interface_PML_acoustic, (/myrank/),if_col)
        endif
        ...
        if (I_should_read_the_database) then
          ...
          call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nglob_interface_PML_elastic, (/myrank/),if_col)
        endif
        ...
        if (sum(offset_nglob_interface_PML_acoustic) > 0) then
          ...
          if (I_should_read_the_database) then
            ...
            call h5_read_dataset_1d_i_collect_hyperslab(dsetname, &
  ...
  if (I_should_read_the_database) then
    ...
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, num_abs_boundary_faces, (/myrank/),if_col)
  endif
  ...
  if (I_should_read_the_database) then
    call h5_read_dataset_1d_i_collect_hyperslab("offset_num_abs_boundary_faces",offset_num_abs_boundary_faces, (/0/), if_col)
  endif
  ...
  if (sum(offset_num_abs_boundary_faces) > 0) then
    if (I_should_read_the_database) then
      call h5_read_dataset_1d_i_collect_hyperslab("offset_nglob_xy",offset_nglob_xy, (/0/), if_col)
    endif
    call bcast_all_i_array_for_database(offset_nglob_xy, size(offset_nglob_xy))

    if (I_should_read_the_database) then
      dsetname = "abs_boundary_ispec"
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, abs_boundary_ispec, &
              (/sum(offset_num_abs_boundary_faces(0:myrank-1))/),if_col)
      dsetname = "abs_boundary_ijk"
      call h5_read_dataset_3d_i_collect_hyperslab(dsetname, abs_boundary_ijk, &
              (/0,0,sum(offset_num_abs_boundary_faces(0:myrank-1))/), if_col)
      dsetname = "abs_boundary_jacobian2Dw"
      call h5_read_dataset_2d_r_collect_hyperslab(dsetname, abs_boundary_jacobian2Dw, &
              (/0,sum(offset_num_abs_boundary_faces(0:myrank-1))/), if_col)
      dsetname = "abs_boundary_normal"
      call h5_read_dataset_3d_r_collect_hyperslab(dsetname, abs_boundary_normal, &
              (/0,0,sum(offset_num_abs_boundary_faces(0:myrank-1))/), if_col)
    endif
    ...
    if (STACEY_ABSORBING_CONDITIONS .and. (.not. PML_CONDITIONS)) then
      ...
      if (ELASTIC_SIMULATION) then
        if (I_should_read_the_database) then
          dsetname = "rmassx"
          call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmassx(1:offset_nglob_xy(myrank)), &
                                                          (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
          dsetname = "rmassy"
          call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmassy(1:offset_nglob_xy(myrank)), &
                                                          (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
          dsetname = "rmassz"
          call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmassz(1:offset_nglob_xy(myrank)), &
                                                          (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
        endif
      ...
      if (ACOUSTIC_SIMULATION) then
        if (I_should_read_the_database) then
          ...
          call h5_read_dataset_1d_r_collect_hyperslab(dsetname, rmassz_acoustic(1:offset_nglob_xy(myrank)), &
                                                          (/sum(offset_nglob_xy(0:myrank-1))/),if_col)
        endif
  ...
  if (I_should_read_the_database) then
    ...
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec2D_xmin, (/myrank/),if_col)
    dsetname = "nspec2D_xmax"
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec2D_xmax, (/myrank/),if_col)
    dsetname = "nspec2D_ymin"
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec2D_ymin, (/myrank/),if_col)
    dsetname = "nspec2D_ymax"
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec2D_ymax, (/myrank/),if_col)
    dsetname = "NSPEC2D_BOTTOM"
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec2D_bottom, (/myrank/),if_col)
    dsetname = "NSPEC2D_TOP"
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec2D_top, (/myrank/),if_col)
  endif
  ...
  if (I_should_read_the_database) then
    ...
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, num_free_surface_faces, (/myrank/),if_col)
  endif
  ...
  if (I_should_read_the_database) then
    call h5_read_dataset_1d_i_collect_hyperslab("offset_num_free_surface_faces",offset_num_free_surface_faces, (/0/), if_col)
  endif
  ...
  if (sum(offset_num_free_surface_faces) > 0) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, free_surface_ispec, &
              (/sum(offset_num_free_surface_faces(0:myrank-1))/),if_col)
      dsetname = "free_surface_ijk"
      call h5_read_dataset_3d_i_collect_hyperslab(dsetname, free_surface_ijk, &
              (/0,0,sum(offset_num_free_surface_faces(0:myrank-1))/),if_col)
      dsetname = "free_surface_jacobian2Dw"
      call h5_read_dataset_2d_r_collect_hyperslab(dsetname, free_surface_jacobian2Dw, &
              (/0,sum(offset_num_free_surface_faces(0:myrank-1))/),if_col)
      dsetname = "free_surface_normal"
      call h5_read_dataset_3d_r_collect_hyperslab(dsetname, free_surface_normal, &
              (/0,0,sum(offset_num_free_surface_faces(0:myrank-1))/),if_col)
    endif
  ...
  if (I_should_read_the_database) then
    call h5_read_dataset_1d_i_collect_hyperslab("offset_num_coupling_ac_el_faces",offset_num_coupling_ac_el_faces,(/0/),if_col)
  endif
  ...
  if (sum(offset_num_coupling_ac_el_faces) > 0) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, coupling_ac_el_ispec, &
            (/sum(offset_num_coupling_ac_el_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_ac_el_ijk"
      call h5_read_dataset_3d_i_collect_hyperslab(dsetname, coupling_ac_el_ijk, &
                (/0,0,sum(offset_num_coupling_ac_el_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_ac_el_jacobian2Dw"
      call h5_read_dataset_2d_r_collect_hyperslab(dsetname, coupling_ac_el_jacobian2Dw, &
               (/0,sum(offset_num_coupling_ac_el_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_ac_el_normal"
      call h5_read_dataset_3d_r_collect_hyperslab(dsetname, coupling_ac_el_normal, &
               (/0,0,sum(offset_num_coupling_ac_el_faces(0:myrank-1))/),if_col)
    endif
  ...
  if (I_should_read_the_database) then
    call h5_read_dataset_1d_i_collect_hyperslab("offset_num_coupling_ac_po_faces",offset_num_coupling_ac_po_faces, (/0/), if_col)
  endif
  ...
  if (sum(offset_num_coupling_ac_po_faces) > 0) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, coupling_ac_po_ispec, &
              (/sum(offset_num_coupling_ac_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_ac_po_ijk"
      call h5_read_dataset_3d_i_collect_hyperslab(dsetname, coupling_ac_po_ijk, &
              (/0,0,sum(offset_num_coupling_ac_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_ac_po_jacobian2Dw"
      call h5_read_dataset_2d_r_collect_hyperslab(dsetname, coupling_ac_po_jacobian2Dw, &
              (/0,sum(offset_num_coupling_ac_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_ac_po_normal"
      call h5_read_dataset_3d_r_collect_hyperslab(dsetname, coupling_ac_po_normal, &
              (/0,0,sum(offset_num_coupling_ac_po_faces(0:myrank-1))/),if_col)
    endif
  ...
  if (I_should_read_the_database) then
    call h5_read_dataset_1d_i_collect_hyperslab("offset_num_coupling_el_po_faces",offset_num_coupling_el_po_faces, (/0/), if_col)
  endif
  ...
  if (sum(offset_num_coupling_el_po_faces) > 0) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, coupling_el_po_ispec, &
              (/sum(offset_num_coupling_el_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_po_el_ispec"
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, coupling_po_el_ispec, &
              (/sum(offset_num_coupling_el_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_el_po_ijk"
      call h5_read_dataset_3d_i_collect_hyperslab(dsetname, coupling_el_po_ijk, &
              (/0,0,sum(offset_num_coupling_el_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_po_el_ijk"
      call h5_read_dataset_3d_i_collect_hyperslab(dsetname, coupling_po_el_ijk, &
              (/0,0,sum(offset_num_coupling_el_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_el_po_jacobian2Dw"
      call h5_read_dataset_2d_r_collect_hyperslab(dsetname, coupling_el_po_jacobian2Dw, &
              (/0,sum(offset_num_coupling_el_po_faces(0:myrank-1))/),if_col)
      dsetname = "coupling_el_po_normal"
      call h5_read_dataset_3d_r_collect_hyperslab(dsetname, coupling_el_po_normal, &
              (/0,0,sum(offset_num_coupling_el_po_faces(0:myrank-1))/),if_col)
    endif
  ...
  if (I_should_read_the_database) then
     ...
     call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, num_interfaces_ext_mesh, (/myrank/),if_col)
  endif
  ...
  if (I_should_read_the_database) then
    call h5_read_dataset_1d_i_collect_hyperslab("offset_num_interfaces_ext_mesh",offset_num_interfaces_ext_mesh, (/0/), if_col)
  endif
  ...
  if (sum(offset_num_interfaces_ext_mesh) > 0) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, max_nibool_interfaces_ext_mesh, (/myrank/),if_col)
    endif
    ...
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, my_neighbors_ext_mesh, &
              (/sum(offset_num_interfaces_ext_mesh(0:myrank-1))/),if_col)
      dsetname = "nibool_interfaces_ext_mesh"
      call h5_read_dataset_1d_i_collect_hyperslab(dsetname, nibool_interfaces_ext_mesh, &
              (/sum(offset_num_interfaces_ext_mesh(0:myrank-1))/),if_col)
      dsetname = "ibool_interfaces_ext_mesh_dummy"
      call h5_read_dataset_2d_i_collect_hyperslab(dsetname, ibool_interfaces_ext_mesh, &
  ...
  if (ELASTIC_SIMULATION .and. ANISOTROPY) then
    if (I_should_read_the_database) then
      call h5_read_dataset_1d_i_collect_hyperslab("offset_nspec_aniso",offset_nspec_aniso, (/0/), if_col)
      dsetname = "c11store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c11store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c12store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c12store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c13store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c13store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c14store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c14store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c15store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c15store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c16store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c16store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c22store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c22store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c23store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c23store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c24store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c24store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c25store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c25store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c26store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c26store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c33store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c33store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c34store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c34store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c35store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c35store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c36store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c36store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c44store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c44store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c45store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c45store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c46store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c46store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c55store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c55store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c56store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c56store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
      dsetname = "c66store"
      call h5_read_dataset_4d_r_collect_hyperslab(dsetname, c66store, (/0,0,0,sum(offset_nspec_aniso(0:myrank-1))/), if_col)
    endif
  ...
  if (I_should_read_the_database) then
    ...
    call h5_read_dataset_1d_l_collect_hyperslab(dsetname, ispec_is_inner,(/sum(offset_nspec(0:myrank-1))/),if_col)
  endif
  ...
  if (ACOUSTIC_SIMULATION) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec_inner_acoustic,(/myrank/),if_col)
      dsetname = "nspec_outer_acoustic"
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec_outer_acoustic,(/myrank/),if_col)
      dsetname = "num_phase_ispec_acoustic"
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, num_phase_ispec_acoustic,(/myrank/),if_col)
    endif
  ...
  if (ELASTIC_SIMULATION) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec_inner_elastic,(/myrank/),if_col)
      dsetname = "nspec_outer_elastic"
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec_outer_elastic,(/myrank/),if_col)
      dsetname = "num_phase_ispec_elastic"
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, num_phase_ispec_elastic,(/myrank/),if_col)
    endif
    ...
    if (I_should_read_the_database) then
      call h5_read_dataset_1d_i_collect_hyperslab("offset_num_phase_ispec_elastic",offset_num_phase_ispec_elastic, (/0/), if_col)
    endif
  ...
  if (POROELASTIC_SIMULATION) then
    if (I_should_read_the_database) then
      ...
      call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nspec_inner_poroelastic,(/myrank/),if_col)
  ...
  if (USE_MESH_COLORING_GPU) then
    ...
    if (ELASTIC_SIMULATION) then
      ...
      if (I_should_read_the_database) then
        ...
        call h5_read_dataset_1d_i_collect_hyperslab(dsetname, num_elem_colors_elastic, &
  ...
  if (I_should_read_the_database) then
    ...
    call h5_read_dataset_scalar_i_collect_hyperslab(dsetname, nfaces_surface, (/myrank/), if_col)
    dsetname = "ispec_is_surface_external_mesh"
    call h5_read_dataset_1d_l_collect_hyperslab(dsetname, ispec_is_surface_external_mesh, &
            (/sum(offset_nspec_ab(0:myrank-1))/), if_col)
    dsetname = "iglob_is_surface_external_mesh"
    call h5_read_dataset_1d_l_collect_hyperslab(dsetname, iglob_is_surface_external_mesh, &
...
!
  ...
  !#TODO: hdf5 version not implemented yet
