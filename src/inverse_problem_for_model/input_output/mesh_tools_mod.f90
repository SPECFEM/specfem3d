module mesh_tools
  ...
  PUBLIC  ::  locate_source, locate_point_in_mesh, compute_source_coeff, locate_MPI_slice_and_bcast_to_all, &
...
!--------------------------------------------------------------------------------------------------------------------
  ...
  subroutine locate_receiver_light(acqui_simu, myrank)
  ...
  end subroutine locate_receiver_light
