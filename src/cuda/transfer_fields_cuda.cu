...
void FC_FUNC_(transfer_fields_ac_to_device,
  ...
  print_CUDA_error_if_any(cudaMemcpy(mp->d_minus_int_int_pressure,minus_int_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyHostToDevice),50110);
  print_CUDA_error_if_any(cudaMemcpy(mp->d_minus_int_pressure,minus_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyHostToDevice),50120);
  print_CUDA_error_if_any(cudaMemcpy(mp->d_minus_pressure,minus_pressure,
...
void FC_FUNC_(transfer_b_fields_ac_to_device,
  ...
  print_CUDA_error_if_any(cudaMemcpy(mp->d_b_minus_int_int_pressure,b_minus_int_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyHostToDevice),51110);
  print_CUDA_error_if_any(cudaMemcpy(mp->d_b_minus_int_pressure,b_minus_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyHostToDevice),51120);
  print_CUDA_error_if_any(cudaMemcpy(mp->d_b_minus_pressure,b_minus_pressure,
...
void FC_FUNC_(transfer_fields_ac_from_device,
  ...
  print_CUDA_error_if_any(cudaMemcpy(minus_int_int_pressure,mp->d_minus_int_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyDeviceToHost),52111);
  print_CUDA_error_if_any(cudaMemcpy(minus_int_pressure,mp->d_minus_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyDeviceToHost),52121);
  print_CUDA_error_if_any(cudaMemcpy(minus_pressure,mp->d_minus_pressure,
...
void FC_FUNC_(transfer_b_fields_ac_from_device,
  ...
  print_CUDA_error_if_any(cudaMemcpy(b_minus_int_int_pressure,mp->d_b_minus_int_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyDeviceToHost),53111);
  print_CUDA_error_if_any(cudaMemcpy(b_minus_int_pressure,mp->d_b_minus_int_pressure,
                                     sizeof(realw)*(*size),cudaMemcpyDeviceToHost),53121);
  print_CUDA_error_if_any(cudaMemcpy(b_minus_pressure,mp->d_b_minus_pressure,
