      ...
      do j = 1, ny
         ...
         do i = 1, nx            
            ...
            if     (modulo(i,2)/=0 .and. modulo(j,2)/=0) then ! Type A
               tupe = 10
            elseif (modulo(i,2)==0 .and. modulo(j,2)/=0) then ! Type B
               tupe = 20
            elseif (modulo(i,2)==0 .and. modulo(j,2)==0) then ! Type C
               tupe = 30
            elseif (modulo(i,2)/=0 .and. modulo(j,2)==0) then ! Type D 
               tupe = 40
            end if
