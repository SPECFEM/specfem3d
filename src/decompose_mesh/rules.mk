...
$O/decompose_mesh_par.dec_module.o: $O/part_decompose_mesh.dec_module.o $(hdf5_mesh_part) $O/fault_scotch.dec_module.o
...
$O/%.dec.o: $S/%.f90 $O/shared_par.shared_module.o $O/part_decompose_mesh.dec_module.o  $O/decompose_mesh_par.dec_module.o $(hdf5_mesh_part) $(hdf5_mesh_SHARED_OBJECTS)
	${FCCOMPILE_CHECK} ${FCFLAGS_f90} $(PART_FLAGS) -c -o $@ $<
