...
#MSUB -r Benchmark_couple32test_SPECFEM3D_DSM        # Nom du job  
#MSUB -n 32
#MSUB -N 2
#MSUB -T 4000
#MSUB -q standard
#MSUB -e Benchmark_couple_run_32test_wangyi.e
#MSUB -o Benchmark_couple_run_32test_wangyi.o
#MSUB -A gen7165 
...
# log file for output 
flog_file=$(pwd)/log.benchmark_wangyi
...
#/ccc/scratch/cont003/gen7165/durochtc/Codes/SPECFEM3Ds/specfem3d/utils/DSM_FOR_SPECFEM3D/bin/xcreate_inputs_files<<EOF
...
source params.in
source $SCRIPTS/scrpits_specfem3D_wangyi.sh
