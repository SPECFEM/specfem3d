...
echo "> ./bin/xadj  $NSTEP $DT $NPROC elastic"
echo
./bin/xadj $NSTEP $DT $NPROC elastic
# checks exit code
if [[ $? -ne 0 ]]; then exit 1; fi
...
echo
echo "postprocessing..."
echo "> ./bin/xpostprocessing $NSTEP $DT $NPROC elastic"
echo
./bin/xpostprocessing $NSTEP $DT $NPROC elastic
# checks exit code
if [[ $? -ne 0 ]]; then exit 1; fi
