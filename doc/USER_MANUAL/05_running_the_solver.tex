...
\noindent
\begin{centering}
{\small \includegraphics[width=0.8\textwidth]{figures/Hollywood_CMT.pdf}
}
\par
\end{centering}
...
\includegraphics[width=3.5in]{figures/gauss_vs_triangle_mod.pdf}
\par\end{centering}
...
\begin{figure}[H]
\noindent \begin{centering}
{\small \includegraphics{figures/STATIONS_basin_explained.pdf} }
\par\end{centering}
